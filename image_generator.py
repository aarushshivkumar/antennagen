...
def main():
    ...
    #contents = ("A telecommunications cell tower or radio tower photographed from ground level at close range, looking up at the lower sections of the tower. The tower structure should be made of metal lattice framework or monopole design. Focus on the bottom 30-50 feet of the tower with multiple antenna arrays of varying sizes mounted at accessible heights, including: large panel antennas (rectangular, approximately 4-6 feet tall), medium-sized directional antennas (2-3 feet), small omnidirectional antennas, cylindrical radome-covered antennas, and microwave dish antennas. Include thick coaxial cables and waveguides running up the tower structure. The antennas should be clearly visible and well-defined with sharp details, good contrast against the sky background. Show antennas mounted on different sides of the tower structure at various heights between 10-40 feet. Include both modern flat panel antennas and traditional cylindrical antenna types. The perspective should show the tower extending upward but focus on the lower antenna installations that would be at maintenance-accessible levels. Ensure antennas range from small (1-2 feet) to large (4-8 feet) for multi-scale detection training.")
    contents = ("""An aerial, high-angle, close-up shot of the mid-to-upper section of a telecom cell phone mast, captured from a drone-like perspective. The primary emphasis is on the multitude of small to medium-sized antennas intricately mounted on the metal lattice structure. Include various smaller antenna types such as compact rectangular panels, slender pole-like antennas, small disc or circular antennas, and other subtle, less obtrusive antenna designs. Interspersed among these antennas and mounting structures are several compact rectangular white equipment boxes with a subtle textured or perforated surface design on the front along with a handle to open the door of the equipment box. Ensure all antennas, especially the smaller ones, are sharply defined and clearly distinguishable against the tower's framework.""")
